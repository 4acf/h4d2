...
public static class SpecialConfig
{
    ...
    public const int HunterDamage = 5;
    ...
    public const int BoomerDamage = 0;
    ...
    public const int SmokerDamage = 5;
    ...
    public const int ChargerDamage = 15;
    ...
    public const int JockeyDamage = 4;
    ...
    public const int SpitterDamage = 7;
    ...
    public const int TankDamage = 24;
    ...
    public const int WitchDamage = 100;
