...
public static class Art
{
    ...
    private static Bitmap[][] _LoadCommons() => _LoadBitmaps("common.png", SpriteSize, 9, 18);
    private static Bitmap[][] _LoadUncommons() => _LoadBitmaps("uncommon.png", SpriteSize, 5, 18);
